...
class Cuztom_Initializer
{
	...
	function register_scripts()
	{
		...
		wp_register_script( 'cuztom', 				CUZTOM_URL . '/assets/js/functions.js', 			array( 'jquery', 'jquery-ui-core',  'jquery-ui-tabs', 'jquery-ui-accordion', 'jquery-ui-sortable', 'wp-color-picker', 'jquery-ui-slider' ), CUZTOM_VERSION, true );
	}
