...
class Turbowp_Template_Handle {

    protected $filter_prefix = 'turbowp-helper';

    protected $theme_template_directory = 'turbowp-helper';

    protected $plugin_directory = TNHP_DIR;
