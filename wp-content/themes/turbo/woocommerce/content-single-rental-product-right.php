...
$feature_img_id  = get_post_thumbnail_id($product_id);
$gallery_imgs_id = explode(',', $gallery);
$galleries       = array_merge(array($feature_img_id), $gallery_imgs_id);
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="rq-listing-single turbo-content-listing-gallery">
                            ...
                            <?php if (isset($show_gallery) && $show_gallery === 'on' && !empty($galleries)) : ?>
                                    ...
                                    <div class="rq-gallery-content">
                                        <div class="details-slider owl-carousel">
                                            <?php foreach ($galleries as $key => $image) : ?>
                                                ...
                                                $large_image = wp_get_attachment_image_src($image, 'car-gallery');
                                                ?>
                                                <div class="item">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar rq-content-block-right">
                            <h2 class="rq-title rq-product-sidebar-heading"><?php echo esc_attr($book_now_heading); ?>
