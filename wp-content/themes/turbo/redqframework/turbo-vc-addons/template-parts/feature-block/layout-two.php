...
<div class="turbo-featured-block rq-content-block <?php echo esc_attr($layout_class); ?> <?php echo esc_attr($content_class); ?>" style="background: url('<?php echo esc_url($featured_image_bg_src); ?>') top center no-repeat; background-size: 100% auto;">
    <div class="container">
        <div class="row">
